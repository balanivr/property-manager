...
class OwnerTable extends React.Component {
    ...
    editRow = (owner) => () => {
        ...
        this.props.onRowEdit && this.props.onRowEdit(owner);
    };
    ...
    handleSendForApproval = (event, owner) => {
        event.stopPropagation();

        this.props.onOwnerSendForApproval && this.props.onOwnerSendForApproval(owner);
    };
                                ...
                                .map(owner => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            key={owner.id}
                                            selected={isSelected}
                                            onClick={selected_record_type === STATUS_TYPES.APPROVED ? null : this.editRow(owner)}
                                            style={{
                                                cursor: 'pointer',
                                        ...
                                        >
                                            ...
                                            <Hidden xsDown={false}>
                                                <TableCell component="th" padding="none">
                                                    {(owner.prefix ? owner.prefix + '. ' : '') + owner.name}
                                                </TableCell>
                                            </Hidden>
                                            <Hidden xsDown={true}>
                                            ...
                                            <Hidden xsDown={false} xsUp={selected_record_type === STATUS_TYPES.APPROVED}>
                                                <TableCell component="th" padding="none" align={"center"}>
                                                    <IconButton onClick={e => this.handleSendForApproval(e, owner)} color="secondary">
                                                        <DoneIcon />
                                                    </IconButton>
                                                </TableCell>
                                            </Hidden>
                                            ...
                                            {/* <TableCell component="th" padding="none" >
                                                <IconButton onClick={this.editRow(owner)}>
                                                    <EditIcon />
                                                </IconButton>
                                            </TableCell> */}
                                        </TableRow>
