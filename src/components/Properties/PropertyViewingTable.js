...
const columns = [
    ...
    { id: 'created_by', numeric: false, hideOnMobile: true, disablePadding: false, label: 'Created By' },
    ...
    { id: 'approve', numeric: true, hideOnMobile: false, conditionalHide: true, disablePadding: false, label: 'Approve' }
];
...
class PropertyTable extends React.Component {
    ...
    viewRecord = (property) => () => {
        ...
        this.props.onRowView && this.props.onRowView(property);
    };
    ...
    handleApprove = (event, property) => {
        event.stopPropagation();
        this.props.approveAction(property);
    }
                                ...
                                .map(property => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            key={property.id}
                                            selected={isSelected}
                                            onClick={selected_record_type === STATUS_TYPES.APPROVED ? null : this.viewRecord(property)}
                                            style={{
                                                cursor: 'pointer',
